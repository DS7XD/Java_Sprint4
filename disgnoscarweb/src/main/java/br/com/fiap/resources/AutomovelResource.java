...
public class AutomovelResource {
    ...
    public Response cadastrarAutomovel(Automovel automovel, @Context UriInfo uriInfo) throws ClassNotFoundException, SQLException {
    ...
    @Path("/{placaAutomovel}")
    @Consumes(MediaType.APPLICATION_JSON)
    public Response atualizarAutomovel(Automovel automovel, @PathParam("placaAutomovel") String placaAutomovel) throws ClassNotFoundException, SQLException {
    ...
    public ArrayList<Automovel> listarAutomoveis() throws ClassNotFoundException, SQLException {
        return (ArrayList<Automovel>) automovelBO.listarAutomoveis();
    }
}
